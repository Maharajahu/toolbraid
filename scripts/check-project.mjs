...
const required = [
  ...
  'video-production/INDEXTTS-LICENSE.txt',
  ...
  'video-production/record-public-demo.py',
  'video-production/transcribe-continuous-narration.py',
  ...
  'docs/diagrams/toolbraid-capabilities.svg',
  ...
  'extension/icons/toolbraid-16.png', 'extension/icons/toolbraid-32.png',
  'extension/icons/toolbraid-48.png', 'extension/icons/toolbraid-128.png',
